...
export default function PowerPointManager({
  ...
  const handleDeleteDoc = (docItem: ExternalPowerPointDoc) => {
    setDocToDelete({
      id: docItem.id,
      title: docItem.title,
        ...
        >
          ...
          >
            ...
            <div className={`p-3.5 rounded-2xl mb-5 text-xs leading-relaxed border ${
              ...
              តើអ្នកពិតជាចង់លុបបទបង្ហាញ PowerPoint <span className="font-bold text-red-600 dark:text-red-400">"{docToDelete.title}"</span> នេះចេញពីប្រព័ន្ធមែនឬទេ?
            </div>

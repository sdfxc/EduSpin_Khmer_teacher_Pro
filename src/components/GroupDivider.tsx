...
import { Users, Plus, Minus, Shuffle, Download, FileSpreadsheet, Award, Check, TrendingUp, Trophy, Loader2, Cloud, ClipboardList, Timer, Table, ChevronLeft } from 'lucide-react';
